...
Page({
  ...
  createactivitysign: function(e){
      var that = this;
      var formData = {"userid": "31701055","activityid": 12};
      wx.showModal({
        title: '提示',
        content: '确认报名[' + e.target.dataset.activityname + ']吗？',
        success: function(sm){
          console.log(JSON.stringify(formData));
            wx.request({
              url: 'http://localhost:8880/api/createactivitysign',
              data: {"userid": wx.getStorageSync('user').userid,"activityid": e.target.dataset.activityid},
              header:{
                "Content-Type": "application/x-www-form-urlencoded"
              },
              method: 'POST',
